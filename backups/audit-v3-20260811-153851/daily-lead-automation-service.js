...
export function createDailyLeadAutomationService({
  ...
  function assignSingleLeadToDraft({
    ...
    // Daily allocation no longer bulk-generates Mini Audits. Call Workspace
    // generates/caches the Mini Audit on demand when the caller opens the lead.
    ...
    lead.timeline.unshift({
      ...
      auditType: lead.auditType || "Mini Audit",
    ...
    draft.salesAssignments.unshift({
      ...
      auditType: lead.auditType || "Mini Audit",
      auditStatus: lead.auditStatus || "queued",
      country: lead.dailyCountry || "",
      regionCode: lead.dailyRegionCode || "",
      status: "assigned",
      queueStatus: "current",
