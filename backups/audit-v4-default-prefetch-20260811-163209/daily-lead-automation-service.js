...
export function createDailyLeadAutomationService({
  ...
  async function executeWorkspaceRun({
    ...
    try {
      ...
      // Production rule: allocation NEVER launches audit jobs.
      // Mini is the default audit contract, but it is generated/cached on demand
      // when the caller opens the lead. This keeps daily 100 allocation lightweight.
  ...
  function assignSingleLeadToDraft({
    ...
    // Allocation records the DEFAULT Mini contract only. No audit job exists yet.
